...
export const metadata: Metadata = {
  ...
  description: 'Speech therapy delivered at your child\'s school or kindergarten in Sydney. Coordinated with teachers and educators. NDIS, Medicare and private pay accepted.',
  alternates: { canonical: '/school-based-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'School-Based Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Speech therapy delivered at your child\'s school or kindergarten in Sydney. Coordinated with teachers and educators. NDIS, Medicare and private pay accepted.',
    url: '/school-based-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Services",
      "item": "https://shineandspeak.com.au/school-based-speech-therapy-sydney-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "School-Based Speech Therapy",
      "item": "https://shineandspeak.com.au/school-based-speech-therapy-sydney-nsw"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/school-based-speech-therapy-sydney-nsw" className="hover:text-[#112A46]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">School-Based Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">School-Based Speech Therapy Sydney NSW</h1>

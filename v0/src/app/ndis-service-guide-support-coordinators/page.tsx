    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/ndis-speech-therapy-sydney-nsw" className="hover:text-[#112A46]">NDIS Speech Therapy</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Service Guide for Support Coordinators</span>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        ...
        <div className="bg-[#FAFAF8] border-l-4 border-[#C89B66] p-6 rounded-r-xl mb-10">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">About our service</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">Referral process</h2>
          <ol className="list-decimal pl-6 space-y-3 text-gray-700">
            <li>Submit an online referral via our <Link href="/refer-a-client" className="text-[#112A46] underline">referral form</Link> or call <a href="tel:0421608819" className="text-[#112A46] underline">{PHONE_DISPLAY}</a></li>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">Management types accepted</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">Reporting and documentation</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <Link href="/speech-therapy-reports-sydney-nsw" className="text-[#112A46] underline">speech therapy report writing services</Link>.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">Service areas and delivery</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-[24px] p-8 text-center mb-12">

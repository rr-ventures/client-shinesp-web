    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#1B365D]">Social Communication</span>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <Link href="/speech-therapy-autism-sydney-nsw" className="text-[#1B365D] underline">autism speech therapy</Link>,{' '}
            <Link href="/speech-therapy-language-delay-sydney-nsw" className="text-[#1B365D] underline">language development support</Link>, and{' '}
            <Link href="/aac-speech-therapy-sydney-nsw" className="text-[#1B365D] underline">AAC and multimodal communication</Link>.
          </p>
        </section>

...
export const metadata: Metadata = {
  ...
  description: 'Evidence-based stuttering and fluency therapy for children and adults in Sydney. Lidcombe Program and other approaches. Mobile and telehealth. NDIS & Medicare registered.',
  alternates: { canonical: '/speech-therapy-stuttering-sydney-nsw' },
  openGraph: {
    title: 'Stuttering & Fluency Therapy Sydney NSW | Shine and Speak',
    description: 'Evidence-based stuttering and fluency therapy for children and adults in Sydney. Lidcombe Program and other approaches. Mobile and telehealth. NDIS & Medicare registered.',
    url: '/speech-therapy-stuttering-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Stuttering & Fluency Therapy",
      "item": "https://shineandspeak.com.au/speech-therapy-stuttering-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Stuttering & Fluency Therapy Sydney NSW",
  "description": "Evidence-based stuttering and fluency therapy for children and adults in Sydney. Lidcombe Program and other approaches. Mobile and telehealth. NDIS & Medicare registered.",
  "url": "https://shineandspeak.com.au/speech-therapy-stuttering-sydney-nsw",
  "provider": {
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/paediatric-speech-therapy-sydney-nsw" className="hover:text-[#112A46]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Stuttering & Fluency Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Stuttering & Fluency Therapy Sydney NSW</h1>

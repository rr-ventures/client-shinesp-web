  ...
  return (
    <article className="min-h-[70vh] flex flex-col">
      ...
      <div className="flex-grow container mx-auto px-4 py-16 md:py-24 max-w-3xl text-center">
        ...
        <div className="bg-[#F0F4F8] rounded-2xl p-8 text-left mb-12">
          <h2 className="text-2xl font-bold text-[#1B365D] mb-6">What to expect next</h2>

          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="flex-shrink-0 bg-[#E8A84C] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">1</div>
              <div>
                <h3 className="font-bold text-[#1B365D] mb-1">We&apos;ll call you back</h3>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 bg-[#E8A84C] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">2</div>
              <div>
                <h3 className="font-bold text-[#1B365D] mb-1">Your free discovery call (15–20 min)</h3>
            ...
            <div className="flex gap-4">
              <div className="flex-shrink-0 bg-[#E8A84C] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">3</div>
              <div>
                <h3 className="font-bold text-[#1B365D] mb-1">What to prepare</h3>
        ...
        <div className="bg-white border-2 border-dashed border-gray-300 rounded-xl p-6 mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:0421608819" className="bg-[#E8A84C] text-white text-center px-8 py-4 rounded-md font-bold hover:bg-amber-600 transition">
            📞 Call {PHONE_DISPLAY}
          </a>
          <Link href="/" className="border-2 border-[#1B365D] text-[#1B365D] text-center px-8 py-4 rounded-md font-bold hover:bg-[#1B365D] hover:text-white transition">
            ← Back to homepage
          </Link>
        </div>
      </div>

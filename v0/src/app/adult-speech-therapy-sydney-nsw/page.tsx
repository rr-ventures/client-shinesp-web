...
export const metadata: Metadata = {
  ...
  description: 'Adult speech therapy in Sydney. Mobile and telehealth for aphasia, stuttering, cognitive-communication, and neurological rehabilitation. NDIS, Medicare and private pay.',
  alternates: { canonical: '/adult-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'Adult Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Adult speech therapy in Sydney. Mobile and telehealth for aphasia, stuttering, cognitive-communication, and neurological rehabilitation. NDIS, Medicare and private pay.',
    url: '/adult-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Services",
      "item": "https://shineandspeak.com.au/adult-speech-therapy-sydney-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Adult Speech Therapy",
      "item": "https://shineandspeak.com.au/adult-speech-therapy-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Adult Speech Therapy Sydney NSW",
  "description": "Adult speech therapy in Sydney. Mobile and telehealth for aphasia, stuttering, cognitive-communication, and neurological rehabilitation. NDIS, Medicare and private pay.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/adult-speech-therapy-sydney-nsw" className="hover:text-[#112A46]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Adult Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Adult Speech Therapy Sydney NSW</h1>

...
import { Brain, Focus, MessageCircle, Mic, Activity, BookOpen, Car, Globe, CreditCard, ClipboardCheck } from 'lucide-react';
...
export const metadata: Metadata = {
  title: 'Mobile Speech Pathologist Sydney NSW | Shine and Speak',
  description:
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="py-24 md:py-32 bg-[#FAFAF8]">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-[#C89B66] font-semibold text-sm tracking-widest uppercase mb-3">Our Services</p>
            <p className="font-serif text-3xl md:text-4xl font-medium text-[#112A46] mb-4">Speech Therapy That Comes to You</p>
            <p className="text-slate-500 font-light text-lg max-w-2xl mx-auto">Comprehensive speech pathology for children and adults across Sydney&apos;s Inner West and beyond.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 pl-0 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#112A46] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">Paediatric Speech Therapy in Sydney</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/paediatric-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Explore paediatric speech therapy services →</Link>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#C89B66] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">Adult Speech Therapy in Sydney</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/adult-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Learn about adult speech therapy in Sydney →</Link>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#C89B66] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">Mobile Speech Therapy</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/mobile-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Discover how mobile speech therapy works →</Link>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#112A46] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">Telehealth Speech Therapy</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/telehealth-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Find out about telehealth speech therapy options →</Link>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#112A46] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">School-Based Speech Therapy</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/school-based-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Learn about school-based speech therapy services →</Link>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex hover:shadow-md transition-shadow duration-300">
              <div className="w-1.5 bg-[#C89B66] flex-shrink-0 rounded-l-2xl"></div>
              <div className="p-8">
                <h2 className="font-serif text-xl font-medium text-[#112A46] mb-3">NDIS Speech Therapy</h2>
                <p className="text-slate-600 font-light leading-relaxed mb-4 text-sm">
                ...
                <Link href="/ndis-speech-therapy-sydney-nsw" className="text-[#112A46] font-semibold text-sm underline underline-offset-4 hover:text-[#C89B66] transition-colors">Access NDIS-funded speech therapy →</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 bg-[#FAFAF8]">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <div className="max-w-3xl mx-auto bg-white p-12 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative">
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-6xl text-[#C89B66] opacity-30 font-serif">&ldquo;</div>
      ...
      <section className="py-24 md:py-32 bg-[#112A46]">
        <div className="container mx-auto px-4 lg:px-8 max-w-2xl text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-medium text-white mb-4">Book Your Free Discovery Call</h2>
          <p className="text-white/70 font-light text-lg mb-10">Tell us about your child and we&apos;ll be in touch within 24 hours.</p>
          <form action="/thank-you" method="GET" className="bg-white rounded-[32px] p-10 shadow-[0_20px_60px_rgba(0,0,0,0.3)] text-left space-y-6">
            <div>
              <label htmlFor="hp-name" className="block text-sm font-medium text-[#112A46] mb-2">Your name</label>
              <input type="text" id="hp-name" name="name" required className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#C89B66] focus:border-transparent" placeholder="Jane Smith" />
            </div>
            <div>
              <label htmlFor="hp-phone" className="block text-sm font-medium text-[#112A46] mb-2">Phone number</label>
              <input type="tel" id="hp-phone" name="phone" required className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#C89B66] focus:border-transparent" placeholder="04XX XXX XXX" />
            </div>
            <div>
              <label htmlFor="hp-email" className="block text-sm font-medium text-[#112A46] mb-2">Email</label>
              <input type="email" id="hp-email" name="email" required className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#C89B66] focus:border-transparent" placeholder="you@example.com" />
            </div>
            <div>
              <label htmlFor="hp-age" className="block text-sm font-medium text-[#112A46] mb-2">Child&apos;s age</label>
              <input type="text" id="hp-age" name="childAge" required className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#C89B66] focus:border-transparent" placeholder="e.g. 4 years" />
            </div>
            <div>
              <label htmlFor="hp-help" className="block text-sm font-medium text-[#112A46] mb-2">What are you looking for help with?</label>
              <select id="hp-help" name="helpWith" required className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#C89B66] focus:border-transparent">
            ...
            <button type="submit" className="w-full bg-[#C89B66] text-white py-4 rounded-xl font-medium text-lg hover:bg-[#b58956] transition-colors">
              Book My Free Discovery Call →
            </button>
          </form>
          <p className="text-white/50 text-sm mt-6 font-light">No obligation. We&apos;ll respond within 24 hours.</p>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-white relative">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center group">
              <div className="mb-6 bg-[#FAFAF8] w-20 h-20 mx-auto rounded-full flex items-center justify-center group-hover:bg-[#F4EBE1] transition-colors">
                <Car className="w-9 h-9 text-[#112A46]" />
              </div>
            ...
            <div className="text-center group">
              <div className="mb-6 bg-[#FAFAF8] w-20 h-20 mx-auto rounded-full flex items-center justify-center group-hover:bg-[#F4EBE1] transition-colors">
                <Globe className="w-9 h-9 text-[#112A46]" />
              </div>
            ...
            <div className="text-center group">
              <div className="mb-6 bg-[#FAFAF8] w-20 h-20 mx-auto rounded-full flex items-center justify-center group-hover:bg-[#F4EBE1] transition-colors">
                <CreditCard className="w-9 h-9 text-[#112A46]" />
              </div>
            ...
            <div className="text-center group">
              <div className="mb-6 bg-[#FAFAF8] w-20 h-20 mx-auto rounded-full flex items-center justify-center group-hover:bg-[#F4EBE1] transition-colors">
                <ClipboardCheck className="w-9 h-9 text-[#112A46]" />
              </div>
        ...
        <div className="container mx-auto px-4 lg:px-8 grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4 mb-10 text-[#112A46] font-medium">
              <li className="flex items-center gap-3"><span className="text-[#C89B66] text-xl">✓</span> <a href="https://www.speechpathologyaustralia.org.au" target="_blank" rel="noopener noreferrer" className="underline decoration-[#C89B66]/30 hover:decoration-[#C89B66] underline-offset-4 transition-all">Certified Practising member of Speech Pathology Australia</a> (CPSP)</li>

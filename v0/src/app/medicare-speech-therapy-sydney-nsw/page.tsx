...
export const metadata: Metadata = {
  ...
  description: 'Medicare rebates for speech therapy in Sydney. Access up to 5 sessions per year with a GP referral under a Chronic Disease Management plan. Mobile and telehealth.',
  alternates: { canonical: '/medicare-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'Medicare Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Medicare rebates for speech therapy in Sydney. Access up to 5 sessions per year with a GP referral under a Chronic Disease Management plan. Mobile and telehealth.',
    url: '/medicare-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Medicare Speech Therapy",
      "item": "https://shineandspeak.com.au/medicare-speech-therapy-sydney-nsw"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Medicare Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Medicare Speech Therapy Sydney NSW</h1>

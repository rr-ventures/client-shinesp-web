...
export const metadata: Metadata = {
  ...
  description: 'Speech therapy for speech sound difficulties in children across Sydney. Clear pronunciation, phonological awareness. Mobile, school-based and telehealth. NDIS & Medicare.',
  alternates: { canonical: '/speech-therapy-speech-sounds-sydney-nsw' },
  openGraph: {
    title: 'Speech Sounds Therapy Sydney NSW | Shine and Speak',
    description: 'Speech therapy for speech sound difficulties in children across Sydney. Clear pronunciation, phonological awareness. Mobile, school-based and telehealth. NDIS & Medicare.',
    url: '/speech-therapy-speech-sounds-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Speech Sounds Therapy",
      "item": "https://shineandspeak.com.au/speech-therapy-speech-sounds-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Speech Sounds Therapy Sydney NSW",
  "description": "Speech therapy for speech sound difficulties in children across Sydney. Clear pronunciation, phonological awareness. Mobile, school-based and telehealth. NDIS & Medicare.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Sounds Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Sounds Therapy Sydney NSW</h1>

    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/parent-coaching-speech-therapy-sydney-nsw" className="hover:text-[#1B365D]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#1B365D]">Parent & Support Worker Coaching</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1B365D] mb-6">Parent & Support Worker Coaching Sydney NSW</h1>

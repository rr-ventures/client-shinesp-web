    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/speech-pathologist-marrickville-nsw" className="hover:text-[#112A46]">Areas</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Pathologist Marrickville</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Pathologist Marrickville NSW</h1>

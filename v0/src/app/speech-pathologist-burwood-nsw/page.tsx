  ...
  return (
    <article>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1B365D] mb-6">Speech Pathologist in Burwood NSW</h1>
        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
          Looking for a speech pathologist in Burwood? We provide mobile speech therapy for children and adults in Burwood NSW and surrounding suburbs. We travel to your home, your child&apos;s school, or local kindergarten — so there&apos;s no need to visit a clinic. We also offer telehealth sessions if that suits your family better.
        </p>
        <p className="text-lg text-gray-700 mb-12 leading-relaxed">
          Burwood is a vibrant, multicultural suburb in Sydney&apos;s Inner West, known for landmarks like Burwood Park and the Westfield Burwood shopping centre. We service families across Burwood and nearby schools and kindergartens, and we also cover neighbouring suburbs including Strathfield, Croydon, and Enfield. From our base in Arncliffe, Burwood is a short 15-minute drive via the M5. To find out more about <a href="https://www.burwood.nsw.gov.au" target="_blank" rel="noopener noreferrer" className="text-[#1B365D] font-medium underline underline-offset-4 hover:opacity-80">the Burwood local community</a>, visit the Burwood Council website.
        </p>

    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span>Areas</span>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Pathologist Burwood</span>
        </div>
      </nav>

      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Pathologist in Burwood</h1>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-serif font-medium text-[#112A46] mb-4">Services available in Burwood</h2>
          <p className="text-gray-700 leading-relaxed">
            Speech therapy for{' '}
            <Link href="/speech-therapy-autism-sydney-nsw" className="text-[#112A46] underline">children on the autism spectrum</Link>,
            ...
            We also provide{' '}
            <Link href="/speech-therapy-assessment-sydney-nsw" className="text-[#112A46] underline">comprehensive speech and language assessments</Link>
            {' '}and detailed reports, and offer coaching for parents and support workers.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-serif font-medium text-[#112A46] mb-4">How mobile therapy works in Burwood</h2>
          <p className="text-gray-700 leading-relaxed">
            ...
            <Link href="/mobile-speech-therapy-sydney-nsw" className="text-[#112A46] underline">mobile speech therapy and how it works</Link>.
          </p>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-serif font-medium text-[#112A46] mb-4">Funding options in Burwood</h2>
          <p className="text-gray-700 leading-relaxed">
            NDIS registered (all management types), Medicare provider, private pay, Home Care Packages, DVA. Visit the{' '}
            <Link href="/fees" className="text-[#112A46] underline font-semibold">fees and funding page</Link>{' '}
            for full details on what&apos;s covered and current session rates.
          </p>
        </section>

        <section className="mb-16">
          <h2 className="text-3xl font-serif font-medium text-[#112A46] mb-4">Languages spoken</h2>
          <p className="text-gray-700 leading-relaxed">
            English and Mandarin (普通话). We provide bilingual assessments and therapy for Mandarin-speaking families in Burwood.
          </p>
        </section>

        <section className="mb-12 bg-gray-50 p-8 rounded-[24px]">
          <h2 className="text-2xl font-serif font-medium text-[#112A46] mb-4">Nearby suburbs we also serve</h2>
          <div className="flex flex-wrap gap-4 text-[#112A46] font-medium">
            <Link href="/speech-pathologist-strathfield-nsw" className="hover:text-[#C89B66]">Strathfield</Link>
            <span className="text-gray-300">•</span>
            <Link href="/speech-pathologist-canterbury-bankstown-nsw" className="hover:text-[#C89B66]">Canterbury-Bankstown</Link>
            <span className="text-gray-300">•</span>
            <Link href="/speech-pathologist-campsie-nsw" className="hover:text-[#C89B66]">Campsie</Link>
            <span className="text-gray-300">•</span>
            <Link href="/speech-pathologist-inner-west-sydney-nsw" className="hover:text-[#C89B66]">Inner West Sydney</Link>
            <span className="text-gray-300">•</span>
            <Link href="/speech-pathologist-arncliffe-nsw" className="hover:text-[#C89B66]">Arncliffe</Link>
          </div>
        </section>

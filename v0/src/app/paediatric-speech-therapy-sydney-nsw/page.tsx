...
export const metadata: Metadata = {
  ...
  description: 'Paediatric speech therapy for children in Sydney. Mobile, school-based and telehealth. Autism, language delay, speech sounds, literacy and more. NDIS & Medicare registered.',
  alternates: { canonical: '/paediatric-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'Paediatric Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Paediatric speech therapy for children in Sydney. Mobile, school-based and telehealth. Autism, language delay, speech sounds, literacy and more. NDIS & Medicare registered.',
    url: '/paediatric-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Paediatric Speech Therapy",
      "item": "https://shineandspeak.com.au/paediatric-speech-therapy-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Paediatric Speech Therapy Sydney NSW",
  "description": "Paediatric speech therapy for children in Sydney. Mobile, school-based and telehealth. Autism, language delay, speech sounds, literacy and more. NDIS & Medicare registered.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Paediatric Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Paediatric Speech Therapy Sydney NSW</h1>

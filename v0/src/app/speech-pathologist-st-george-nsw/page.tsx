...
export const metadata: Metadata = {
  ...
  description: "Speech Pathologist St George NSW at Shine and Speak. Mobile and telehealth speech pathology services.",
};

export default function PlaceholderPage() {
  return (
    <article className="container mx-auto px-4 py-20 max-w-4xl text-center min-h-[60vh] flex flex-col justify-center">
      <h1 className="text-4xl md:text-5xl font-bold text-brand-navy mb-6">Speech Pathologist St George NSW</h1>

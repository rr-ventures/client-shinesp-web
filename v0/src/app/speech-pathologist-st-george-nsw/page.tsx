    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/speech-pathologist-st-george-nsw" className="hover:text-[#1B365D]">Areas</Link>
          <span className="mx-2">›</span>
          <span className="text-[#1B365D]">Speech Pathologist St George</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1B365D] mb-6">Speech Pathologist St George NSW</h1>

...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive speech and language assessments for children and adults in Sydney. Mobile, school-based and telehealth. Detailed reports provided. NDIS & Medicare.',
  alternates: { canonical: '/speech-therapy-assessment-sydney-nsw' },
  openGraph: {
    title: 'Speech Therapy Assessment Sydney NSW | Shine and Speak',
    description: 'Comprehensive speech and language assessments for children and adults in Sydney. Mobile, school-based and telehealth. Detailed reports provided. NDIS & Medicare.',
    url: '/speech-therapy-assessment-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Services",
      "item": "https://shineandspeak.com.au/speech-therapy-assessment-sydney-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/speech-therapy-assessment-sydney-nsw" className="hover:text-[#112A46]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Therapy Assessments</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Therapy Assessment Sydney NSW</h1>

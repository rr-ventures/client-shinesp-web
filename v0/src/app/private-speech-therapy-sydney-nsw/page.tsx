...
export const metadata: Metadata = {
  ...
  description: 'Private speech therapy for children and adults in Sydney. No referral needed. Flexible scheduling, mobile home visits and telehealth. Receipts provided for health insurance.',
  alternates: { canonical: '/private-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'Private Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Private speech therapy for children and adults in Sydney. No referral needed. Flexible scheduling, mobile home visits and telehealth. Receipts provided for health insurance.',
    url: '/private-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://shineandspeak.com.au/private-speech-therapy-sydney-nsw"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Private Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Private Speech Therapy Sydney NSW</h1>

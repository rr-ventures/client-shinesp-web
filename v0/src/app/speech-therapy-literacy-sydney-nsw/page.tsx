...
export const metadata: Metadata = {
  ...
  description: 'Speech therapy for literacy and reading difficulties in children across Sydney. Phonological awareness, reading and spelling support. Mobile, school-based. NDIS & Medicare.',
  alternates: { canonical: '/speech-therapy-literacy-sydney-nsw' },
  openGraph: {
    title: 'Literacy & Reading Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Speech therapy for literacy and reading difficulties in children across Sydney. Phonological awareness, reading and spelling support. Mobile, school-based. NDIS & Medicare.',
    url: '/speech-therapy-literacy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Literacy & Reading Therapy",
      "item": "https://shineandspeak.com.au/speech-therapy-literacy-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Literacy & Reading Speech Therapy Sydney NSW",
  "description": "Speech therapy for literacy and reading difficulties in children across Sydney. Phonological awareness, reading and spelling support. Mobile, school-based. NDIS & Medicare.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Literacy & Reading Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Literacy & Reading Speech Therapy Sydney NSW</h1>

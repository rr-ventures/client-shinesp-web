...
export const metadata: Metadata = {
  ...
  description: 'Speech therapy for children with ADHD in Sydney. Building focus, listening, and social communication skills. Mobile, school-based and telehealth. NDIS & Medicare registered.',
  alternates: { canonical: '/speech-therapy-adhd-sydney-nsw' },
  openGraph: {
    title: 'Speech Therapy for ADHD Sydney NSW | Shine and Speak',
    description: 'Speech therapy for children with ADHD in Sydney. Building focus, listening, and social communication skills. Mobile, school-based and telehealth. NDIS & Medicare registered.',
    url: '/speech-therapy-adhd-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Speech Therapy for ADHD",
      "item": "https://shineandspeak.com.au/speech-therapy-adhd-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Speech Therapy for ADHD Sydney NSW",
  "description": "Speech therapy for children with ADHD in Sydney. Building focus, listening, and social communication skills. Mobile, school-based and telehealth. NDIS & Medicare registered.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Therapy for ADHD</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Therapy for ADHD Sydney NSW</h1>

...
export const metadata: Metadata = {
  ...
  description: 'How Shine and Speak speech therapy works — from your first discovery call through assessment, goal-setting, and ongoing therapy. Mobile and telehealth in Sydney.',
  alternates: { canonical: '/how-it-works' },
  openGraph: {
    title: 'How It Works — Speech Therapy Process | Shine and Speak',
    description: 'How Shine and Speak speech therapy works — from your first discovery call through assessment, goal-setting, and ongoing therapy. Mobile and telehealth in Sydney.',
    url: '/how-it-works',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "How It Works",
      "item": "https://shineandspeak.com.au/how-it-works"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="text-[#112A46]">How It Works</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">How It Works — Speech Therapy Process</h1>

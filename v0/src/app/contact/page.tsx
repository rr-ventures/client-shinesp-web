...
export const metadata: Metadata = {
  ...
  description: 'Contact Shine and Speak speech pathology in Sydney. Call, email or WhatsApp us. We respond within 24 hours. Mobile and telehealth speech therapy Inner West Sydney.',
  alternates: { canonical: '/contact' },
  openGraph: {
    title: 'Contact Shine and Speak | Shine and Speak',
    description: 'Contact Shine and Speak speech pathology in Sydney. Call, email or WhatsApp us. We respond within 24 hours. Mobile and telehealth speech therapy Inner West Sydney.',
    url: '/contact',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Contact",
      "item": "https://shineandspeak.com.au/contact"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="text-[#112A46]">Contact</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Contact Shine and Speak</h1>

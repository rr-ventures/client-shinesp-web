...
export default function FloatingButtons() {
  return (
    <div className="fixed bottom-6 right-4 z-50 flex flex-col items-end gap-3">
      ...
      {/* Mobile click-to-call button — mobile only */}
      <a
        href="tel:0421608819"
        aria-label="Call Shine and Speak on 0421 608 819"
        className="md:hidden flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-transform hover:scale-105 active:scale-95"

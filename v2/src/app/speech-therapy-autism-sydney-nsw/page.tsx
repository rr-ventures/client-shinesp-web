    ...
    <main>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">What is autism spectrum disorder?</h2>
          ...
          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">Signs to look for</h2>
          <ul className="space-y-4 mb-12 text-lg text-gray-700">
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Limited or no spoken language for their age</li>
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Difficulty with back-and-forth conversation or taking turns</li>
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Challenges understanding what others say or following instructions</li>
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Repetitive use of words or phrases (echolalia)</li>
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Trouble understanding social cues, body language, or facial expressions</li>
            <li className="flex items-start"><CheckCircle2 className="w-6 h-6 mr-3 text-[#E8A84C] flex-shrink-0 mt-0.5" /> Preference for routine and difficulty with transitions</li>
          </ul>

          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">How speech therapy helps</h2>
          <p className="text-lg text-gray-700 mb-12">
          ...
          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">What to expect in sessions</h2>
          <p className="text-lg text-gray-700 mb-12">
            Sessions are play-based, structured around your child's interests, and take place in familiar environments — your home, their school, or online. I also provide practical coaching for parents and support workers so communication strategies are used consistently across all settings. Learn more about <Link href="/how-it-works" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">how therapy works</Link> and what your first session looks like.
          </p>

          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">Parent and support worker coaching</h2>
          <p className="text-lg text-gray-700 mb-12">
          ...
          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">Funding your child's therapy</h2>
          <p className="text-lg text-gray-700 mb-12">
            Speech therapy for autism is covered under most NDIS plans and may be eligible for Medicare rebates with a referral from your GP. I accept all NDIS management types. Find out more about <Link href="/ndis-speech-therapy-sydney-nsw" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">NDIS funding for speech therapy</Link> or check the full list of <Link href="/fees" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">funding options and fees</Link>.
          </p>

          <h2 className="text-3xl font-bold text-[#1B365D] mb-6">Related conditions</h2>
          <p className="text-lg text-gray-700 mb-12">
            Many children on the autism spectrum also experience challenges with <Link href="/speech-therapy-adhd-sydney-nsw" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">attention and focus</Link>, <Link href="/speech-therapy-language-delay-sydney-nsw" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">language development</Link>, <Link href="/speech-therapy-social-communication-sydney-nsw" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">social communication</Link>, or may benefit from <Link href="/speech-therapy-aac-sydney-nsw" className="text-[#1B365D] underline font-medium hover:text-[#E8A84C]">AAC and multimodal communication</Link> support. I work across all of these areas.
          </p>
        </div>
      </section>

      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-left mb-12">
          ...
          <div className="space-y-6">
            <div className="flex">
              <div className="flex-shrink-0 w-8 h-8 bg-gold-100 text-gold-600 rounded-full flex items-center justify-center font-bold mr-4">1</div>
              <div>
                <h3 className="text-lg font-bold text-navy-900 mb-2">The Discovery Call</h3>
            ...
            <div className="flex">
              <div className="flex-shrink-0 w-8 h-8 bg-gold-100 text-gold-600 rounded-full flex items-center justify-center font-bold mr-4">2</div>
              <div>
                <h3 className="text-lg font-bold text-navy-900 mb-2">What to prepare</h3>
        ...
        <div className="bg-navy-50 p-8 rounded-2xl border border-navy-100 text-left flex flex-col sm:flex-row items-center justify-between mb-12">
          <div className="mb-6 sm:mb-0 sm:mr-6">
            <h3 className="text-xl font-bold text-navy-900 mb-2">Free Resource</h3>
            <p className="text-gray-700">Download our checklist: "Is My Child's Speech on Track?"</p>
          </div>
          <button className="flex-shrink-0 flex items-center bg-white border border-navy-200 text-navy-900 font-bold px-6 py-3 rounded-md hover:bg-gray-50 transition-colors">

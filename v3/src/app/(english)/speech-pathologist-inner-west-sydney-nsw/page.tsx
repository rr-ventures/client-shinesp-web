...
export const metadata: Metadata = {
  ...
  description:
    "Mobile speech therapy across the Inner West Sydney. Burwood, Strathfield, Marrickville & more. NDIS, Medicare & private. Bilingual English & Mandarin. Book now.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-pathologist-inner-west-sydney-nsw",
  },
  openGraph: {
    title: "Speech Pathologist Inner West Sydney NSW | Shine and Speak",
    description: "Mobile speech therapy across the Inner West Sydney. Burwood, Strathfield, Marrickville & more. NDIS, Medicare & private. Bilingual English & Mandarin. Book now.",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Pathologist in Inner West Sydney", href: "/speech-pathologist-inner-west-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Pathologist in Inner West Sydney NSW</h1>

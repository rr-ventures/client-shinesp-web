...
export const metadata: Metadata = {
  ...
  description:
    "Mobile speech therapy delivered to your home, school, or community in Sydney. No clinic needed. NDIS, Medicare & private. Inner West Sydney & surrounds.",
  alternates: {
    canonical: "https://shineandspeak.com.au/mobile-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Mobile Speech Therapy Sydney NSW | Shine and Speak",
    description: "Mobile speech therapy delivered to your home, school, or community in Sydney. No clinic needed. NDIS, Medicare & private. Inner West Sydney & surrounds.",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/mobile-speech-therapy-sydney-nsw" },
          { name: "Mobile Speech Therapy Sydney NSW", href: "/mobile-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/mobile-speech-therapy-sydney-nsw">Services</Link> &rsaquo;{" "}
          Mobile Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Mobile Speech Therapy Sydney NSW</h1>

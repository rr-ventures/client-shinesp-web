...
export const metadata: Metadata = {
  ...
  description:
    "Adult speech therapy in Sydney for aphasia, fluency, cognitive-communication & neurological rehabilitation. Mobile & telehealth. NDIS & Medicare. Book a free call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/adult-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Adult Speech Therapy Sydney NSW | Shine and Speak",
    description: "Adult speech therapy in Sydney for aphasia, fluency, cognitive-communication & neurological rehabilitation. Mobile & telehealth. NDIS & Medicare. Book a free call.",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Adult Speech Therapy Sydney NSW", href: "/adult-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Adult Speech Therapy Sydney NSW</h1>

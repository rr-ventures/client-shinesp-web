...
export const metadata: Metadata = {
  ...
  description:
    "Private pay speech therapy in Sydney. No referral needed. Mobile, telehealth & school-based sessions. Inner West Sydney. Book a free discovery call today.",
  alternates: {
    canonical: "https://shineandspeak.com.au/private-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Private Speech Therapy Sydney NSW | Shine and Speak",
    description: "Private pay speech therapy in Sydney. No referral needed. Mobile, telehealth & school-based sessions. Inner West Sydney. Book a free discovery call today.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Private Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Funding & Fees", href: "/private-speech-therapy-sydney-nsw" },
          { name: "Private Speech Therapy Sydney NSW", href: "/private-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/private-speech-therapy-sydney-nsw">Funding & Fees</Link> &rsaquo;{" "}
          Private Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Private Speech Therapy Sydney NSW</h1>

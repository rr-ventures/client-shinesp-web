...
export const metadata: Metadata = {
  title: "Speech Therapy for Literacy Sydney NSW | Shine and Speak",
  description:
    "Literacy and reading therapy in Sydney. Supporting reading, writing, and spelling development. Mobile, telehealth & school-based. NDIS & Medicare. Book a call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-therapy-literacy-sydney-nsw",
  },
  openGraph: {
    title: "Speech Therapy for Literacy Sydney NSW | Shine and Speak",
    description: "Literacy and reading therapy in Sydney. Supporting reading, writing, and spelling development. Mobile, telehealth & school-based. NDIS & Medicare. Book a call.",
    url: "https://shineandspeak.com.au/speech-therapy-literacy-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Therapy for Literacy in Sydney NSW",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Therapy for Literacy in Sydney NSW", href: "/speech-therapy-literacy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          Speech Therapy for Literacy in Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy for Literacy in Sydney NSW</h1>

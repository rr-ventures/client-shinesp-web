...
export const metadata: Metadata = {
  ...
  description:
    "Evidence-based stuttering therapy in Sydney for children and adults. Lidcombe Program and more. Mobile & telehealth. NDIS & Medicare. Book a free call today.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-therapy-stuttering-sydney-nsw",
  },
  openGraph: {
    title: "Speech Therapy for Stuttering Sydney NSW | Shine and Speak",
    description: "Evidence-based stuttering therapy in Sydney for children and adults. Lidcombe Program and more. Mobile & telehealth. NDIS & Medicare. Book a free call today.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Therapy for Stuttering in Sydney NSW",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Therapy for Stuttering in Sydney NSW", href: "/speech-therapy-stuttering-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          Speech Therapy for Stuttering in Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy for Stuttering in Sydney NSW</h1>

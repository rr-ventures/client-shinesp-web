...
export const metadata: Metadata = {
  ...
  description:
    "Mobile speech therapy in Hurstville NSW. Home visits, school sessions & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin. Book a free call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-pathologist-hurstville-nsw",
  },
  openGraph: {
    title: "Speech Pathologist Hurstville NSW | Shine and Speak",
    description: "Mobile speech therapy in Hurstville NSW. Home visits, school sessions & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin. Book a free call.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Pathologist in Hurstville",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Pathologist in Hurstville", href: "/speech-pathologist-hurstville-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Pathologist in Hurstville NSW</h1>

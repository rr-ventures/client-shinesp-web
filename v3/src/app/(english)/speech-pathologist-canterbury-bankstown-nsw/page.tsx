...
export const metadata: Metadata = {
  ...
  description:
    "Mobile speech therapy in Canterbury-Bankstown NSW. Home, school & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin. Book a free call today.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-pathologist-canterbury-bankstown-nsw",
  },
  openGraph: {
    title: "Speech Pathologist Canterbury-Bankstown NSW | Shine and Speak",
    description: "Mobile speech therapy in Canterbury-Bankstown NSW. Home, school & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin. Book a free call today.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Pathologist in Canterbury-Bankstown",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Pathologist in Canterbury-Bankstown", href: "/speech-pathologist-canterbury-bankstown-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Pathologist in Canterbury-Bankstown NSW</h1>

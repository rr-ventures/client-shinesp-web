...
export const metadata: Metadata = {
  ...
  description:
    "Speech therapy funded through Home Care Packages in Sydney. Mobile & telehealth. Shine and Speak accepts HCP funding. Inner West Sydney & surrounds.",
  alternates: {
    canonical: "https://shineandspeak.com.au/home-care-package-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Home Care Package Speech Therapy Sydney | Shine and Speak",
    description: "Speech therapy funded through Home Care Packages in Sydney. Mobile & telehealth. Shine and Speak accepts HCP funding. Inner West Sydney & surrounds.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Home Care Package Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Funding & Fees", href: "/home-care-package-speech-therapy-sydney-nsw" },
          { name: "Home Care Package Speech Therapy Sydney NSW", href: "/home-care-package-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/home-care-package-speech-therapy-sydney-nsw">Funding & Fees</Link> &rsaquo;{" "}
          Home Care Package Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Home Care Package Speech Therapy Sydney NSW</h1>

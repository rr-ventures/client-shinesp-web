...
export const metadata: Metadata = {
  ...
  description:
    "Medicare rebates for speech therapy in Sydney. Shine and Speak is a registered Medicare provider. Book with a GP referral. Inner West Sydney & telehealth.",
  alternates: {
    canonical: "https://shineandspeak.com.au/medicare-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Medicare Speech Therapy Sydney NSW | Shine and Speak",
    description: "Medicare rebates for speech therapy in Sydney. Shine and Speak is a registered Medicare provider. Book with a GP referral. Inner West Sydney & telehealth.",
    url: "https://shineandspeak.com.au/medicare-speech-therapy-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Medicare Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Funding & Fees", href: "/medicare-speech-therapy-sydney-nsw" },
          { name: "Medicare Speech Therapy Sydney NSW", href: "/medicare-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/medicare-speech-therapy-sydney-nsw">Funding & Fees</Link> &rsaquo;{" "}
          Medicare Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Medicare Speech Therapy Sydney NSW</h1>

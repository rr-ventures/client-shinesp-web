...
export const metadata: Metadata = {
  title: "Telehealth Speech Therapy Sydney NSW | Shine and Speak",
  description:
    "Telehealth speech therapy online — anywhere in Australia. Paediatric & adult services. NDIS & Medicare. Bilingual English & Mandarin. Book a free discovery call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/telehealth-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Telehealth Speech Therapy Sydney NSW | Shine and Speak",
    description: "Telehealth speech therapy online — anywhere in Australia. Paediatric & adult services. NDIS & Medicare. Bilingual English & Mandarin. Book a free discovery call.",
    url: "https://shineandspeak.com.au/telehealth-speech-therapy-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Telehealth Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/telehealth-speech-therapy-sydney-nsw" },
          { name: "Telehealth Speech Therapy Sydney NSW", href: "/telehealth-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/telehealth-speech-therapy-sydney-nsw">Services</Link> &rsaquo;{" "}
          Telehealth Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Telehealth Speech Therapy Sydney NSW</h1>

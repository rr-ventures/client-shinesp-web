...
export const metadata: Metadata = {
  ...
  description:
    "DVA-funded speech therapy in Sydney for veterans and dependants. Mobile & telehealth delivery. Inner West Sydney. Shine and Speak accepts DVA funding.",
  alternates: {
    canonical: "https://shineandspeak.com.au/dva-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "DVA Speech Therapy Sydney NSW | Shine and Speak",
    description: "DVA-funded speech therapy in Sydney for veterans and dependants. Mobile & telehealth delivery. Inner West Sydney. Shine and Speak accepts DVA funding.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "DVA Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Funding & Fees", href: "/dva-speech-therapy-sydney-nsw" },
          { name: "DVA Speech Therapy Sydney NSW", href: "/dva-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/dva-speech-therapy-sydney-nsw">Funding & Fees</Link> &rsaquo;{" "}
          DVA Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">DVA Speech Therapy Sydney NSW</h1>

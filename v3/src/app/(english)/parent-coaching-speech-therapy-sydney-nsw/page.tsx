...
export const metadata: Metadata = {
  ...
  description:
    "Parent and support worker coaching in Sydney. Learn strategies to support your child's communication at home. NDIS & Medicare. Mobile & telehealth sessions.",
  alternates: {
    canonical: "https://shineandspeak.com.au/parent-coaching-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Parent Coaching Speech Therapy Sydney | Shine and Speak",
    description: "Parent and support worker coaching in Sydney. Learn strategies to support your child's communication at home. NDIS & Medicare. Mobile & telehealth sessions.",
    url: "https://shineandspeak.com.au/parent-coaching-speech-therapy-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Parent and Support Worker Coaching Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/parent-coaching-speech-therapy-sydney-nsw" },
          { name: "Parent and Support Worker Coaching Sydney NSW", href: "/parent-coaching-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/parent-coaching-speech-therapy-sydney-nsw">Services</Link> &rsaquo;{" "}
          Parent and Support Worker Coaching Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Parent and Support Worker Coaching Sydney NSW</h1>

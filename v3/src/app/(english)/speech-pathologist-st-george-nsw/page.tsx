...
export const metadata: Metadata = {
  ...
  description:
    "Mobile speech therapy in St George NSW. Hurstville, Kogarah, Rockdale & more. Home, school & telehealth. NDIS, Medicare & private. Bilingual. Book a free call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-pathologist-st-george-nsw",
  },
  openGraph: {
    title: "Speech Pathologist St George NSW | Shine and Speak",
    description: "Mobile speech therapy in St George NSW. Hurstville, Kogarah, Rockdale & more. Home, school & telehealth. NDIS, Medicare & private. Bilingual. Book a free call.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Pathologist in St George",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Pathologist in St George", href: "/speech-pathologist-st-george-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Pathologist in St George NSW</h1>

    ...
    <main className="flex flex-col min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "serviceType": "Speech Therapy for Autism",
            "provider": {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-sm text-gray-500 mb-8">
          <Link href="/">Home</Link> &gt; <Link href="/paediatric-speech-therapy-sydney-nsw">Services</Link> &gt; Speech Therapy for Autism
        </div>
        
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy for Autism and ASD in Sydney</h1>

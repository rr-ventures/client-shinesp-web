...
export const metadata = {
  ...
  description: 'Parent coaching for speech therapy in Sydney NSW. Evidence-based strategies to support your child at home every day. Mobile and telehealth sessions available.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Parent Coaching Speech Therapy Sydney NSW' }],
  },
};
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Parent & Support Worker Coaching</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">
              Parent & Support Worker Coaching
            </h1>
          </div>
        </div>
      </section>

...
export const metadata = {
  ...
  description: 'Thank you for contacting Shine and Speak. We will reply within 1 business day to discuss speech therapy in Sydney NSW. We look forward to helping your family.',
  alternates: {

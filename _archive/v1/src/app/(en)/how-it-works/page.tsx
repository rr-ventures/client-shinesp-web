...
export const metadata = {
  title: 'How It Works | Shine and Speak Speech Pathology',
  description: 'How speech therapy works at Shine and Speak in Sydney NSW. Free discovery call, comprehensive assessment, personalised therapy plan. NDIS & Medicare accepted.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'How Speech Therapy Works | Shine and Speak' }],
  },
};

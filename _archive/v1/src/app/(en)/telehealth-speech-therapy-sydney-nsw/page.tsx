...
export const metadata = {
  ...
  description: 'Telehealth speech therapy in Sydney NSW and Australia-wide. Online sessions via video. NDIS, Medicare and private pay accepted. Bilingual English and Mandarin.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Telehealth Speech Therapy Sydney NSW' }],
  },
};
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Telehealth Speech Therapy</span>
          </nav>
        </div>
      </div>

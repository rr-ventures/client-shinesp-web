...
export const metadata = {
  ...
  description: 'Comprehensive speech pathology assessments in Sydney NSW. Mobile, school & telehealth. Detailed reports for NDIS, school, Medicare & other funding bodies.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy Assessment Sydney NSW' }],
  },
};

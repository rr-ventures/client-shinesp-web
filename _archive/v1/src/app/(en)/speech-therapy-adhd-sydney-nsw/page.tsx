...
export const metadata = {
  ...
  description: 'Speech therapy for children with ADHD in Sydney NSW. Mobile, school-based & telehealth. Focus, listening & communication support. NDIS, Medicare & private.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy for ADHD Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy for ADHD in Sydney",
            "url": "https://shineandspeak.com.au/speech-therapy-adhd-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy for ADHD in Sydney</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">
              Speech Therapy for ADHD in Sydney
            </h1>
          </div>
        </div>
      </section>

...
export const metadata = {
  ...
  description: 'School-based speech therapy in Sydney NSW. I visit your child at school or kindergarten. NDIS, Medicare and private. Bilingual English and Mandarin available.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'School-Based Speech Therapy Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "School-Based Speech Therapy in Sydney",
            "url": "https://shineandspeak.com.au/school-based-speech-therapy-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">School-Based Speech Therapy in Sydney</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">
              School-Based Speech Therapy in Sydney
            </h1>
          </div>
        </div>
      </section>

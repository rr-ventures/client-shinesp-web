...
export const metadata = {
  ...
  description: 'Speech therapy for speech sounds & articulation in Sydney NSW. Mobile, school & telehealth. Helping children pronounce clearly. NDIS, Medicare & private pay.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy Speech Sounds Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy for Speech Sounds",
            "url": "https://shineandspeak.com.au/speech-therapy-speech-sounds-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy for Speech Sounds</span>
          </nav>
        </div>
      </div>

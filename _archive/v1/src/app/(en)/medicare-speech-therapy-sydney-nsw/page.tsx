...
export const metadata = {
  ...
  description: 'Medicare-rebated speech therapy in Sydney NSW. Claim under the Chronic Disease Management plan with a GP referral. Mobile, school-based and telehealth sessions.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Medicare Speech Therapy Sydney NSW' }],
  },
};
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Medicare Speech Therapy</span>
          </nav>
        </div>
      </div>

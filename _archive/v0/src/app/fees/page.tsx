...
export const metadata: Metadata = {
  title: 'Fees & Pricing',
  description: 'Speech therapy fees and pricing at Shine and Speak. NDIS, Medicare, private pay and Home Care Package rates. Transparent pricing with no hidden costs. Sydney and telehealth.',
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Fees & Pricing</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Fees & Pricing</h1>

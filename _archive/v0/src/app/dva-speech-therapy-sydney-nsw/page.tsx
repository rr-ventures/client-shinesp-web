...
export const metadata: Metadata = {
  ...
  description: 'DVA-funded speech therapy for veterans and their families in Sydney. Mobile and telehealth sessions available. Registered allied health provider for DVA clients.',
  alternates: { canonical: '/dva-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'DVA Speech Therapy Sydney NSW | Shine and Speak',
    description: 'DVA-funded speech therapy for veterans and their families in Sydney. Mobile and telehealth sessions available. Registered allied health provider for DVA clients.',
    url: '/dva-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "DVA Speech Therapy",
      "item": "https://shineandspeak.com.au/dva-speech-therapy-sydney-nsw"
    }
  ]
};
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">DVA Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">DVA Speech Therapy Sydney NSW</h1>

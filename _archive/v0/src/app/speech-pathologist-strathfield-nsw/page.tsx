...
export const metadata: Metadata = {
  ...
  description: 'Mobile speech pathologist in Strathfield NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.',
  alternates: { canonical: '/speech-pathologist-strathfield-nsw' },
  openGraph: {
    title: 'Speech Pathologist Strathfield NSW | Shine and Speak',
    description: 'Mobile speech pathologist in Strathfield NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.',
    url: '/speech-pathologist-strathfield-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Areas",
      "item": "https://shineandspeak.com.au/speech-pathologist-strathfield-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Speech Pathologist Strathfield",
      "item": "https://shineandspeak.com.au/speech-pathologist-strathfield-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Speech Pathologist Strathfield NSW",
  "description": "Mobile speech pathologist in Strathfield NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.",
  "url": "https://shineandspeak.com.au/speech-pathologist-strathfield-nsw",
  "provider": {
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/speech-pathologist-strathfield-nsw" className="hover:text-[#112A46]">Areas</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Pathologist Strathfield</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Pathologist Strathfield NSW</h1>

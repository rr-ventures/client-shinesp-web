...
export const metadata: Metadata = {
  ...
  description: 'Mobile speech pathologist in the St George area, NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.',
  alternates: { canonical: '/speech-pathologist-st-george-nsw' },
  openGraph: {
    title: 'Speech Pathologist St George NSW | Shine and Speak',
    description: 'Mobile speech pathologist in the St George area, NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.',
    url: '/speech-pathologist-st-george-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Areas",
      "item": "https://shineandspeak.com.au/speech-pathologist-st-george-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Speech Pathologist St George",
      "item": "https://shineandspeak.com.au/speech-pathologist-st-george-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Speech Pathologist St George NSW",
  "description": "Mobile speech pathologist in the St George area, NSW. Home visits, school sessions and telehealth. NDIS, Medicare and private pay accepted. Bilingual English & Mandarin.",
  "url": "https://shineandspeak.com.au/speech-pathologist-st-george-nsw",
  "provider": {
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/speech-pathologist-st-george-nsw" className="hover:text-[#112A46]">Areas</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Speech Pathologist St George</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Speech Pathologist St George NSW</h1>

...
export const metadata: Metadata = {
  ...
  description: 'Online speech therapy via telehealth, available across Sydney and Australia-wide. Flexible, evidence-based sessions from home. NDIS, Medicare and private pay accepted.',
  alternates: { canonical: '/telehealth-speech-therapy-sydney-nsw' },
  openGraph: {
    title: 'Telehealth Speech Therapy Sydney & Australia-wide | Shine and Speak',
    description: 'Online speech therapy via telehealth, available across Sydney and Australia-wide. Flexible, evidence-based sessions from home. NDIS, Medicare and private pay accepted.',
    url: '/telehealth-speech-therapy-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Services",
      "item": "https://shineandspeak.com.au/telehealth-speech-therapy-sydney-nsw"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Telehealth Speech Therapy",
      "item": "https://shineandspeak.com.au/telehealth-speech-therapy-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Telehealth Speech Therapy Sydney & Australia-wide",
  "description": "Online speech therapy via telehealth, available across Sydney and Australia-wide. Flexible, evidence-based sessions from home. NDIS, Medicare and private pay accepted.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <Link href="/telehealth-speech-therapy-sydney-nsw" className="hover:text-[#112A46]">Services</Link>
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Telehealth Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Telehealth Speech Therapy Sydney & Australia-wide</h1>

...
export const metadata: Metadata = {
  ...
  description: 'Speech therapy for language delay in children across Sydney. Building vocabulary, comprehension and sentence skills. Mobile, school-based and telehealth. NDIS & Medicare.',
  alternates: { canonical: '/speech-therapy-language-delay-sydney-nsw' },
  openGraph: {
    title: 'Language Delay Speech Therapy Sydney NSW | Shine and Speak',
    description: 'Speech therapy for language delay in children across Sydney. Building vocabulary, comprehension and sentence skills. Mobile, school-based and telehealth. NDIS & Medicare.',
    url: '/speech-therapy-language-delay-sydney-nsw',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Language Delay Speech Therapy",
      "item": "https://shineandspeak.com.au/speech-therapy-language-delay-sydney-nsw"
    }
  ]
};
...
const serviceSchemaData = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Language Delay Speech Therapy Sydney NSW",
  "description": "Speech therapy for language delay in children across Sydney. Building vocabulary, comprehension and sentence skills. Mobile, school-based and telehealth. NDIS & Medicare.",
    ...
    <article>
      ...
      <nav className="bg-gray-50 py-3 border-b border-gray-200 text-sm" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 text-gray-500">
          ...
          <span className="mx-2">›</span>
          <span className="text-[#112A46]">Language Delay Speech Therapy</span>
        </div>
      </nav>
      <div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl">
        <h1 className="text-4xl md:text-5xl font-serif font-medium text-[#112A46] mb-6">Language Delay Speech Therapy Sydney NSW</h1>

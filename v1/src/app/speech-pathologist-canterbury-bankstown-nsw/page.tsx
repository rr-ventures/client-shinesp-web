...
export const metadata = {
  ...
  description: 'Mobile speech therapy in Canterbury-Bankstown. Home, school & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin.',
  alternates: {
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Pathologist in Canterbury-Bankstown</span>
          </nav>
        </div>
      </div>

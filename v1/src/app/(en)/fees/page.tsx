...
export const metadata = {
  ...
  description: 'Speech therapy fees and funding options in Sydney NSW. NDIS, Medicare, private pay, Home Care Packages and DVA. Transparent pricing with no hidden costs.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy Fees & Funding Sydney' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy Fees & Funding Sydney",
            "provider": {
                        "@type": "Organization",
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Fees & Pricing</span>
          </nav>
        </div>
      </div>

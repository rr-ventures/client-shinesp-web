...
export const metadata = {
  title: 'Contact Shine and Speak | Speech Pathologist Sydney',
  description: 'Contact Shine and Speak for mobile speech therapy in Sydney NSW. Book a free discovery call, send an email, or refer a client. Bilingual English & Mandarin.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Contact Shine and Speak | Speech Therapy Sydney' }],
  },
};

...
export const metadata = {
  ...
  description: 'Speech therapy for aphasia and acquired communication disorders in Sydney NSW. Mobile and telehealth. NDIS, Medicare & private. Personalised rehabilitation.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Aphasia Speech Therapy Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy for Aphasia",
            "url": "https://shineandspeak.com.au/speech-therapy-aphasia-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy for Aphasia</span>
          </nav>
        </div>
      </div>

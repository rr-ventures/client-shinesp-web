...
export const metadata = {
  ...
  description: 'Speech therapy for literacy & reading difficulties in Sydney NSW. Mobile, school & telehealth. Supporting reading, writing & spelling. NDIS, Medicare & private.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy for Literacy Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy for Literacy",
            "url": "https://shineandspeak.com.au/speech-therapy-literacy-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy for Literacy</span>
          </nav>
        </div>
      </div>

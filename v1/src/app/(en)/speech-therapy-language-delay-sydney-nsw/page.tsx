...
export const metadata = {
  title: 'Speech Therapy for Language Delay Sydney | Shine and Speak',
  description: 'Speech therapy for language delay in Sydney NSW. Mobile, school & telehealth. Building vocabulary, understanding & expression. NDIS, Medicare & private pay.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy Language Delay Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Speech Therapy for Language Delay",
            "url": "https://shineandspeak.com.au/speech-therapy-language-delay-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy for Language Delay</span>
          </nav>
        </div>
      </div>

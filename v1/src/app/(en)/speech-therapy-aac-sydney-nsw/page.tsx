...
export const metadata = {
  ...
  description: 'AAC and multimodal communication therapy in Sydney NSW. Supporting children who need alternative ways to communicate. Mobile, school & telehealth. NDIS funded.',
  alternates: {
    canonical: 'https://shineandspeak.com.au/speech-therapy-aac-sydney-nsw',
  },
  openGraph: {
    title: 'AAC Speech Therapy Sydney NSW | Shine and Speak',
    description: 'AAC and multimodal communication therapy in Sydney NSW. Supporting children who need alternative ways to communicate. Mobile, school & telehealth. NDIS funded.',
    url: 'https://shineandspeak.com.au/speech-therapy-aac-sydney-nsw',
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'AAC Speech Therapy Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "AAC & Multimodal Communication",
            "url": "https://shineandspeak.com.au/speech-therapy-aac-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">AAC & Multimodal Communication</span>
          </nav>
        </div>
      </div>

...
export const metadata = {
  ...
  description: 'Mobile speech therapy in Sydney NSW — delivered to your home, school or kindergarten. No clinic visits needed. NDIS, Medicare & private. Bilingual available.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Mobile Speech Therapy Sydney NSW' }],
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Mobile Speech Therapy in Sydney",
            "url": "https://shineandspeak.com.au/mobile-speech-therapy-sydney-nsw"
          })
        }}
      />
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Mobile Speech Therapy in Sydney</span>
          </nav>
        </div>
      </div>

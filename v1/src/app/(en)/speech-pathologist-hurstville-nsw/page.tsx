...
export const metadata = {
  ...
  description: 'Mobile speech pathologist in Hurstville, Inner West Sydney. Home visits, school visits & telehealth. NDIS, Medicare & private. Bilingual English & Mandarin.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Pathologist Hurstville NSW' }],
  },
};
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Pathologist in Hurstville</span>
          </nav>
        </div>
      </div>

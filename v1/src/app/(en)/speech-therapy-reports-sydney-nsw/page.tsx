...
export const metadata = {
  title: 'Speech Therapy Reports Sydney | Shine and Speak',
  description: 'Speech pathology reports for NDIS, school, Medicare and plan reviews in Sydney NSW. Detailed, timely, evidence-based assessment reports. Mobile service.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Speech Therapy Reports Sydney NSW' }],
  },
};
      ...
      <div className="bg-accent py-4 border-b border-gray-200">
        <div className="container-custom">
          <nav className="text-sm text-gray-600 flex items-center gap-2">
            ...
            <span>&gt;</span>
            <span className="text-primary font-medium">Speech Therapy Reports</span>
          </nav>
        </div>
      </div>

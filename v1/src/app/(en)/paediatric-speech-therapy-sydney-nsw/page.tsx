...
export const metadata = {
  ...
  description: 'Paediatric speech therapy in Sydney NSW. Mobile, school & telehealth. Supporting children with autism, language delay, speech sounds, literacy & ADHD.',
  alternates: {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://shineandspeak.com.au/og-image.png', width: 1200, height: 630, alt: 'Paediatric Speech Therapy Sydney NSW' }],
  },
};

...
export const metadata: Metadata = {
  title: "School-Based Speech Therapy Sydney NSW | Shine and Speak",
  description:
    "School-based speech therapy in Sydney. I visit your child's school or kindergarten. NDIS & Medicare. Bilingual English & Mandarin. Inner West Sydney.",
  alternates: {
    canonical: "https://shineandspeak.com.au/school-based-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "School-Based Speech Therapy Sydney NSW | Shine and Speak",
    description: "School-based speech therapy in Sydney. I visit your child's school or kindergarten. NDIS & Medicare. Bilingual English & Mandarin. Inner West Sydney.",
    url: "https://shineandspeak.com.au/school-based-speech-therapy-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "School-Based Speech Therapy Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/school-based-speech-therapy-sydney-nsw" },
          { name: "School-Based Speech Therapy Sydney NSW", href: "/school-based-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/school-based-speech-therapy-sydney-nsw">Services</Link> &rsaquo;{" "}
          School-Based Speech Therapy Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">School-Based Speech Therapy Sydney NSW</h1>

...
export const metadata: Metadata = {
  ...
  description:
    "Speech therapy for aphasia in Sydney. Supporting adults after stroke or brain injury. Mobile & telehealth. NDIS, Medicare & private. Book a free discovery call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-therapy-aphasia-sydney-nsw",
  },
  openGraph: {
    title: "Speech Therapy for Aphasia Sydney NSW | Shine and Speak",
    description: "Speech therapy for aphasia in Sydney. Supporting adults after stroke or brain injury. Mobile & telehealth. NDIS, Medicare & private. Book a free discovery call.",
    url: "https://shineandspeak.com.au/speech-therapy-aphasia-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Therapy for Aphasia in Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/adult-speech-therapy-sydney-nsw" },
          { name: "Speech Therapy for Aphasia in Sydney NSW", href: "/speech-therapy-aphasia-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/adult-speech-therapy-sydney-nsw">Services</Link> &rsaquo;{" "}
          Speech Therapy for Aphasia in Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy for Aphasia in Sydney NSW</h1>

...
export const metadata: Metadata = {
  ...
  description:
    "Paediatric speech therapy in Sydney. Mobile, school-based & telehealth. Autism, ADHD, language delay, speech sounds & more. NDIS & Medicare. Book a free call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/paediatric-speech-therapy-sydney-nsw",
  },
  openGraph: {
    title: "Paediatric Speech Therapy Sydney NSW | Shine and Speak",
    description: "Paediatric speech therapy in Sydney. Mobile, school-based & telehealth. Autism, ADHD, language delay, speech sounds & more. NDIS & Medicare. Book a free call.",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Paediatric Speech Therapy Sydney NSW", href: "/paediatric-speech-therapy-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <h1 className="text-4xl font-bold text-navy-blue mb-6">Paediatric Speech Therapy Sydney NSW</h1>

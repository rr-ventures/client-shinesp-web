...
export const metadata: Metadata = {
  ...
  description:
    "Speech therapy for children with ADHD in Sydney. Focus, listening, and social communication strategies. Mobile, telehealth & school-based. NDIS & Medicare.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-therapy-adhd-sydney-nsw",
  },
  openGraph: {
    title: "Speech Therapy for ADHD Sydney NSW | Shine and Speak",
    description: "Speech therapy for children with ADHD in Sydney. Focus, listening, and social communication strategies. Mobile, telehealth & school-based. NDIS & Medicare.",
    url: "https://shineandspeak.com.au/speech-therapy-adhd-sydney-nsw",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Therapy for ADHD in Sydney NSW",
  provider: {
    "@type": "Organization",
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Speech Therapy for ADHD in Sydney NSW", href: "/speech-therapy-adhd-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          Speech Therapy for ADHD in Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy for ADHD in Sydney NSW</h1>

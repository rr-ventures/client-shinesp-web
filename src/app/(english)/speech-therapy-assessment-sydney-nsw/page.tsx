...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive speech and language assessments in Sydney. Home, school & telehealth. NDIS & Medicare. Detailed reports with recommendations. Book a free call.",
  alternates: {
    canonical: "https://shineandspeak.com.au/speech-therapy-assessment-sydney-nsw",
  },
  openGraph: {
    title: "Speech Therapy Assessment Sydney NSW | Shine and Speak",
    description: "Comprehensive speech and language assessments in Sydney. Home, school & telehealth. NDIS & Medicare. Detailed reports with recommendations. Book a free call.",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Speech Therapy Assessment Sydney NSW",
  provider: {
    "@type": "Organization",
  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <BreadcrumbSchema
        items={[
          { name: "Home", href: "/" },
          { name: "Services", href: "/speech-therapy-assessment-sydney-nsw" },
          { name: "Speech Therapy Assessment Sydney NSW", href: "/speech-therapy-assessment-sydney-nsw" },
        ]}
      />
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <nav aria-label="Breadcrumb" className="text-sm text-gray-500 mb-8">
          ...
          <Link href="/speech-therapy-assessment-sydney-nsw">Services</Link> &rsaquo;{" "}
          Speech Therapy Assessment Sydney NSW
        </nav>

        <h1 className="text-4xl font-bold text-navy-blue mb-6">Speech Therapy Assessment Sydney NSW</h1>

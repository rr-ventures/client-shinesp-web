...
export const metadata: Metadata = {
  title: "Thank You — We'll Be in Touch | Shine and Speak",
  description:
    "Thank you for contacting Shine and Speak. We'll be in touch within 24 hours to arrange your free discovery call. Here's what to expect next.",
  alternates: {
    canonical: "https://shineandspeak.com.au/thank-you",
  },
  openGraph: {
    title: "Thank You — We'll Be in Touch | Shine and Speak",
    description: "Thank you for contacting Shine and Speak. We'll be in touch within 24 hours.",
    url: "https://shineandspeak.com.au/thank-you",
  },
};
...
export default function ThankYouPage() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-center bg-blue-50 py-20">
      <BreadcrumbSchema items={[{ name: "Home", href: "/" }, { name: "Thank You", href: "/thank-you" }]} />
      ...
      <div className="container mx-auto px-4 max-w-2xl text-center bg-white p-12 rounded-2xl shadow-xl">
        ...
        <div className="text-left bg-gray-50 p-6 rounded-xl mb-8">
          ...
          <p className="text-gray-700">
            If you have any previous reports from paediatricians, teachers, or other allied health professionals, please have them ready. It&apos;s also helpful to note a few specific examples of situations where your child finds communication challenging.
          </p>
          {/* PLACEHOLDER: Downloadable "Is My Child's Speech on Track?" checklist PDF */}
        </div>

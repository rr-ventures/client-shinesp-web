  ...
  return (
    <main className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm font-semibold text-white/85">
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-white text-xs font-bold">✓</span> 澳洲认证言语治疗师 (CPSP)</span>
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-white text-xs font-bold">✓</span> NDIS 注册服务提供商</span>
              <span className="flex items-center gap-2"><span className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-white text-xs font-bold">✓</span> Medicare 医疗保险提供商</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-golden-amber text-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white">准备好帮助您或您的孩子茁壮成长了吗？</h2>

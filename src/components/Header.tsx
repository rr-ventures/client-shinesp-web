    ...
    <header className="sticky top-0 z-50 glass-nav transition-all duration-300">
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex lg:hidden items-center gap-2">
          <a href="tel:+61421608819" className="text-navy-blue font-medium text-xs hover:text-trust-teal transition flex items-center gap-1 px-2 py-1.5" aria-label="Call us">
        ...
        <div className="lg:hidden bg-white border-t border-gray-100 shadow-2xl absolute w-full left-0">
          ...
          <div className="flex flex-col gap-3 p-4 border-b border-gray-100">
            ...
            <a
              ...
              className="w-full text-center text-navy-blue font-semibold py-2 inline-flex items-center justify-center gap-2"
            >
